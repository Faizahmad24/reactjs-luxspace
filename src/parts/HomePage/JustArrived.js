...
function Loading() {
  return Array(6).fill().map((_, index) => {
    return <div className='px-4 relative card group' key={index}>
         <div className="rounded-xl bg-gray-300 overflow-hidden card-shadow relative" style={{ width: 287, height: 386 }}></div>
    ...
    <section className="flex flex-col py-16">
      ...
      <div className="overflow-x-hidden px-4" id="carousel">
        ...
        {/* <div className="flex -mx-4 flex-row relative"> */}
          {
            isLoading ? <div className="flex -mx-4 flex-row relative"><Loading/></div> 
            : error 
