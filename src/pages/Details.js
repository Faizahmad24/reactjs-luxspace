  ...
  return (
    <section className="container mx-auto">
            <div className="flex flex-wrap my-4 md:my-12">
                ...
                <div className='w-44 h-8 mt-6 bg-gray-300 animate-pulse rounded-full'></div>
                {/* <a
                    href="cart.html"
...
export default function Details() {
  const {idp} = useParams();
  // console.log("ini param : ", {idp})
  const {data, run, isLoading} = useAsync({data: "ahuy"})
  ...
  return (
    <>
        ...
        {isLoading ? <LoadingProductDetails></LoadingProductDetails> : <ProductDetails data={data}/>}
